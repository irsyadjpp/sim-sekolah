            ...
            <Box className="flex flex-col gap-10">
              <Box className="flex flex-col">
                ...
                <Typography variant="body1" className="text-text-primary">
                  Welcome to SIM Sekolah! These terms and conditions outline the rules and regulations for the use of
                  our school portal. By accessing this website we assume you accept these terms and conditions. Do not
                  continue to use this portal if you do not agree to all of the terms and conditions stated on this
                  page.
                </Typography>
              </Box>
              ...
              <Box>
                ...
                <Typography variant="body1">
                  Other than the content you own, under these Terms, SIM Sekolah and/or its licensors own all the
                ...
                <Typography variant="body1">
                  This Website is provided “as is,” with all faults, and SIM Sekolah expresses no representations or
                  warranties.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  In no event shall SIM Sekolah, nor any of its officers, directors and employees, be held liable for
                ...
                <Typography variant="body1">
                  You hereby indemnify to the fullest extent SIM Sekolah from and against any and all liabilities,
                ...
                <Typography variant="body1">
                  SIM Sekolah is permitted to revise these Terms at any time as it sees fit.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  These Terms constitute the entire agreement between SIM Sekolah and you.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  These Terms will be governed by and interpreted in accordance with the laws of Indonesia, and you

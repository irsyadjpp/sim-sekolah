            ...
            <Box className="flex flex-col gap-10">
              <Box className="flex flex-col">
                ...
                <Typography variant="body1" className="text-text-primary">
                  Silakan masukkan kode 6 digit yang dikirim ke alamat email Anda.
                </Typography>
              </Box>
              ...
              <Box className="flex flex-col gap-5">
                <Box component={"form"} onSubmit={handleSubmit} className="flex flex-col">
                  <Box className="flex flex-col">
                    <FormLabel component="label">Kode Verifikasi</FormLabel>
              ...
              <Box className="flex flex-col">
                ...
                <Typography variant="body1" className="text-text-secondary">
                  Jika Anda belum menerima kode tersebut, silakan{" "}

...
export default function SummativePage() {
  ...
  const { paginatedData, page, limit, total, sortBy, sortDir, handlePageChange, handleLimitChange, handleSort } =
    useClientTable({ key: "summative", data: assessments, defaultLimit: 10 });
  ...
  return (
    <Box>
      ...
      <Breadcrumbs className="mb-6">
        ...
        <Typography variant="body2">Sumatif</Typography>
      </Breadcrumbs>
          ...
          <Table>
            ...
            <TableBody>
              {loading ? (
                  ...
                  <TableRow key={a.id} hover>
                    ...
                    <TableCell align="center">
                      <Button
                        ...
                        onClick={() => navigate(`/academic/evaluation/summative/details?id=${a.id}`)}
                        className="mr-2"
                      >
                        Input Nilai
                      </Button>
                ...
                <TableRow>
                  <TableCell colSpan={4} align="center" className="py-10">
                    Tidak ada data asesmen sumatif untuk kelas ini.
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
      ...
      <Dialog open={openModal} onClose={() => setOpenModal(false)} maxWidth="sm" fullWidth>
        <DialogTitle>Buat Asesmen Sumatif Baru</DialogTitle>
        <DialogContent dividers>
          <Box className="flex flex-col gap-4 pt-2">
            <TextField
              label="Nama Asesmen (Misal: Ujian Akhir Semester)"
              fullWidth
              size="small"

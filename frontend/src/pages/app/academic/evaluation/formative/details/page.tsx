...
export default function FormativeDetailsPage() {
  ...
  useEffect(() => {
    if (!id) {
      navigate("/academic/evaluation/formative");
      return;
    }
    fetchData();
  }, [id]);
  ...
  return (
    <Box>
      ...
      <Breadcrumbs className="mb-6">
        ...
        <Link to="/academic/evaluation/formative">Formatif</Link>
                      ...
                      <TableRow key={e.id} hover>
                        ...
                        <TableCell>
                          <TextField
                            ...
                            size="small"
                            fullWidth
                            aria-label={`Nilai angka formatif untuk ${e.student.full_name}`}
                            value={s.score}
                        ...
                        <TableCell>
                          <TextField
                            ...
                            fullWidth
                            placeholder="Catatan..."
                            aria-label={`Catatan umpan balik formatif untuk ${e.student.full_name}`}
                            value={s.notes}

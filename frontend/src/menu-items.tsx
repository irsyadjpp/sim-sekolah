...
export const leftMenuItems: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "ppdb-data", label: "PPDB Online", icon: "NiBadge", href: "/ppdb/admin" },
...
export const leftMenuBottomItems: MenuItem[] = [
  {
    ...
    children: [
      ...
      { id: "academic-year", label: "Siklus Tahun Ajaran", icon: "NiCalendar", href: "/system/academic-years" },
      { id: "grade-level", label: "Master Tingkat Kelas", icon: "NiLayout", href: "/system/grades" },

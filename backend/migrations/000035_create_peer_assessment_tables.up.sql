...
CREATE INDEX idx_peer_template_deleted ON master_peer_assessment_template(deleted_at);
...
CREATE INDEX idx_self_assessment_deleted ON trx_self_assessment(deleted_at);
...
CREATE INDEX idx_peer_assessment_deleted ON trx_peer_assessment(deleted_at);
...
CREATE INDEX idx_group_assessment_deleted ON trx_group_assessment(deleted_at);
...
CREATE INDEX idx_group_assessment_member_deleted ON trx_group_assessment_member(deleted_at);
...
CREATE INDEX idx_peer_guideline_deleted ON master_peer_assessment_guideline(deleted_at);

...
func (h *ClassroomHandler) GetAllClassrooms(c *fiber.Ctx) error {
	...
	if err != nil {
		return common.Error(c, fiber.StatusInternalServerError, "Gagal mengambil data rombel", err.Error())
	}
...
func (h *ClassroomHandler) GetClassroomByID(c *fiber.Ctx) error {
	...
	if err != nil {
		return common.Error(c, fiber.StatusNotFound, "Rombel tidak ditemukan", err.Error())
	}
...
func (h *ClassroomHandler) CreateClassroom(c *fiber.Ctx) error {
	...
	if err != nil {
		return common.Error(c, fiber.StatusInternalServerError, "Gagal membuat rombel", err.Error())
	}
...
func (h *ClassroomHandler) UpdateClassroom(c *fiber.Ctx) error {
	...
	if err != nil {
		return common.Error(c, fiber.StatusInternalServerError, "Gagal memperbarui rombel", err.Error())
	}
...
func (h *ClassroomHandler) DeleteClassroom(c *fiber.Ctx) error {
	if err := h.svc.Delete(c.UserContext(), c.Params("id")); err != nil {
		return common.Error(c, fiber.StatusInternalServerError, "Gagal menghapus rombel", err.Error())
	}
